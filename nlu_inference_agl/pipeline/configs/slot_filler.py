...
from nlu_inference_agl.constants import STOP_WORDS
from nlu_inference_agl.pipeline.configs import (
...
class CRFSlotFillerConfig(FromDict, ProcessingUnitConfig):
    ...
    def __init__(self, feature_factory_configs=None,
        ...
        if tagging_scheme is None:
            from nlu_inference_agl.slot_filler.crf_utils import TaggingScheme
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.slot_filler import CRFSlotFiller
