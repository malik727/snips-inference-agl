...
from nlu_inference_agl.pipeline.configs import Config, ProcessingUnitConfig
...
class LogRegIntentClassifierConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_classifier import LogRegIntentClassifier
...
class FeaturizerConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_classifier import Featurizer
...
class TfidfVectorizerConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_classifier import TfidfVectorizer
...
class CooccurrenceVectorizerConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_classifier import CooccurrenceVectorizer
