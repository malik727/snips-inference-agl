...
from nlu_inference_agl.common.from_dict import FromDict
from nlu_inference_agl.constants import CUSTOM_ENTITY_PARSER_USAGE, STOP_WORDS
from nlu_inference_agl.entity_parser import CustomEntityParserUsage
from nlu_inference_agl.pipeline.configs import ProcessingUnitConfig
from nlu_inference_agl.resources import merge_required_resources
...
class ProbabilisticIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    def __init__(self, intent_classifier_config=None, slot_filler_config=None):
        from nlu_inference_agl.intent_classifier import IntentClassifier
        from nlu_inference_agl.slot_filler import SlotFiller
        ...
        if slot_filler_config is None:
            from nlu_inference_agl.pipeline.configs import CRFSlotFillerConfig
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_parser import ProbabilisticIntentParser
...
class DeterministicIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_parser import DeterministicIntentParser
...
class LookupIntentParserConfig(FromDict, ProcessingUnitConfig):
    ...
    @property
    def unit_name(self):
        from nlu_inference_agl.intent_parser.lookup_intent_parser import \
            LookupIntentParser
