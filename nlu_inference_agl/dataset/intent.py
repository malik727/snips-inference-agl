...
from nlu_inference_agl.constants import DATA, ENTITY, SLOT_NAME, TEXT, UTTERANCES
from nlu_inference_agl.exceptions import IntentFormatError
...
class IntentUtterance(object):
    ...
    def parse(cls, string):
        ...
        Examples:
            ...
            >>> from nlu_inference_agl.dataset.intent import IntentUtterance
            >>> u = IntentUtterance.\
