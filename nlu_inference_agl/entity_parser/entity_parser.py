...
from nlu_inference_agl.common.dict_utils import LimitedSizeDict
...
try:
    ...
    from nlu_inference_agl.common.abc_utils import abstractclassmethod
         ...
         :class:`.EntityParser`
            ...
            Returns:
                list of dict: list of the parsed entities. These entity must
                    ...
                    :func:`nlu_inference_agl.utils.result.parsed_entity` function
        """
        pass
